...
F = np.array([
    [ -0.3113, -0.0992, 0.0149, -0.0075 ],
    [ 0.0180, -0.4402, 0.0049, 0.0026 ],
    [ -40.4705, -18.7705, 1.9852, -1.4978 ],
    [ 3.6793, -63.8747, 0.9756, -0.4775 ]
], dtype=np.float64)
...
H = np.array([ 7.5038, -35.3634, 1.9767, -3.0198 ], dtype=np.float64)  # shape (4,)
