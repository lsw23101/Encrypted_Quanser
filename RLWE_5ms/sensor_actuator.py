...
'''
F = np.array([
    [ -0.3287, -0.0150, 0.0054, -0.0010 ],
    [ 0.0012, -0.3554, 0.0004, 0.0041 ],
    [ -87.9291, -5.4598, 1.1758, -0.3825 ],
    [ 0.4884, -95.3186, 0.1738, 0.6232 ]
], dtype=np.float64)
...
H = np.array([ 2.0083, -19.6680, 0.7068, -1.5448 ], dtype=np.float64)  # shape (4,)
