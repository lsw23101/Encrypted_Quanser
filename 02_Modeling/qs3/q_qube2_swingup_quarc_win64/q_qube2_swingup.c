...
void q_qube2_swingup_output(void)
{
  ...
  if (tmp) {
    ...
    /* Gain: '<S4>/Gain' */
    q_qube2_swingup_B.Gain = q_qube2_swingup_P.Gain_Gain *
      q_qube2_swingup_B.Pendulumcountstorad;
  }

  /* Gain: '<S7>/J to mJ' */
  q_qube2_swingup_B.JtomJ = q_qube2_swingup_P.JtomJ_Gain *
    q_qube2_swingup_B.Energy;
  if (tmp) {
    /* Gain: '<S5>/Gain' */
    q_qube2_swingup_B.Gain_b = q_qube2_swingup_P.Gain_Gain_a *
      q_qube2_swingup_B.Armcountstorad;
  }
}
...
RT_MODEL_q_qube2_swingup_T *q_qube2_swingup(void)
{
  ...
  /* External mode info */
  q_qube2_swingup_M->Sizes.checksums[0] = (3609380520U);
  q_qube2_swingup_M->Sizes.checksums[1] = (2756618951U);
  q_qube2_swingup_M->Sizes.checksums[2] = (3410229693U);
  q_qube2_swingup_M->Sizes.checksums[3] = (438695713U);
...

  {
    ...
    q_qube2_swingup_B.Gain = 0.0;
    q_qube2_swingup_B.JtomJ = 0.0;
    q_qube2_swingup_B.Gain_b = 0.0;
  ...
  q_qube2_swingup_M->Sizes.numBlocks = (54);/* Number of blocks */
  q_qube2_swingup_M->Sizes.numBlockIO = (40);/* Number of block outputs */
  q_qube2_swingup_M->Sizes.numBlockPrms = (124);/* Sum of parameter "widths" */
