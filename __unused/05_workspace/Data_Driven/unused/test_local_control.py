...
F = np.array([
    [ -0.4043, -0.5207, -0.0032, 0.0127 ],
    [ -0.6765, -0.0548, -0.0004, 0.0070 ],
    [ -20.7330, -15.6197, 0.2097, 0.2627 ],
    [ -23.3347, -12.2996, -0.0012, 0.1610 ],
], dtype=np.float64)
...
H = np.array([ 14.8995, -1.1488, -0.2020, 1.6112 ], dtype=np.float64)  # shape (4,)
