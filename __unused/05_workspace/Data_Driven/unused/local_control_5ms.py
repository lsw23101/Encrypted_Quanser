...
# 식별한 제어기로 설계한 observer based dynamic controller

F = np.array([
    [ -0.2792, -0.1902, -0.0010, 0.0052 ],
    [ -0.1560, -0.2620, -0.0001, 0.0032 ],
    [ 222.8183, -369.6551, 0.7316, 0.2310 ],
    [ -4.1146, -93.0243, -0.0097, 0.8565 ],
], dtype=np.float64)
...
H = np.array([ 20.4214, 0.7266, -0.2551, 1.7196 ], dtype=np.float64)  # shape (4,)
