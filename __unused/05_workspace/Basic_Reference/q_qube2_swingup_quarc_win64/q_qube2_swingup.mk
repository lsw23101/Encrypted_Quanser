###########################################################################
## Makefile generated for component 'q_qube2_swingup'. 
## 
## Makefile     : q_qube2_swingup.mk
## Generated on : Wed Feb 04 13:31:52 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_swingup.rt-win64
...
PRODUCT_NAME              = q_qube2_swingup
MAKEFILE                  = q_qube2_swingup.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\publi\Desktop\swlee\05_workspace\Basic_Reference
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = q_qube2_swingup_comp.rsp
CMD_FILE                  = q_qube2_swingup.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_swingup.rt-win64
...
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=1 -DALLOCATIONFCN=0 -DMAT_FILE=0 -DONESTEPFCN=0 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=1
DEFINES_STANDARD = -DMODEL=q_qube2_swingup -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup.c $(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup_data.c $(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup_main.c $(START_DIR)\q_qube2_swingup_quarc_win64\rtGetInf.c $(START_DIR)\q_qube2_swingup_quarc_win64\rtGetNaN.c $(START_DIR)\q_qube2_swingup_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_qube2_swingup.obj q_qube2_swingup_data.obj q_qube2_swingup_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_qube2_swingup_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_qube2_swingup_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_qube2_swingup.obj : "$(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup.c"


q_qube2_swingup_data.obj : "$(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup_data.c"


q_qube2_swingup_main.obj : "$(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_swingup_quarc_win64\q_qube2_swingup_main.c"


rtGetInf.obj : "$(START_DIR)\q_qube2_swingup_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_swingup_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_qube2_swingup_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_swingup_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_qube2_swingup_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_swingup_quarc_win64\rt_nonfinite.c"
