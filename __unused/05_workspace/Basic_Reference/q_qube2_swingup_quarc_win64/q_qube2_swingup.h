...
#ifndef q_qube2_swingup_h_
#define q_qube2_swingup_h_
...
extern XDis_q_qube2_swingup_T q_qube2_swingup_XDis;
 ...
 *
 * Block '<Root>/Motor Voltage (V)' : Unused code path elimination
 * Block '<Root>/Pendulum (deg)' : Unused code path elimination
 * Block '<Root>/Pendulum Energy (mJ)' : Unused code path elimination
 * Block '<S4>/Gain' : Unused code path elimination
 * Block '<S5>/Gain' : Unused code path elimination
 * Block '<Root>/Rotary Arm (deg)' : Unused code path elimination
 * Block '<S11>/Data Type Duplicate' : Unused code path elimination
 * Block '<S11>/Data Type Propagation' : Unused code path elimination
 * Block '<S7>/J to mJ' : Unused code path elimination
 */
 ...
 * '<S1>'   : 'q_qube2_swingup/Counts to Angles'
 * '<S2>'   : 'q_qube2_swingup/Enable Balance Control'
 * '<S3>'   : 'q_qube2_swingup/Er'
 * '<S4>'   : 'q_qube2_swingup/Radians to Degrees'
 * '<S5>'   : 'q_qube2_swingup/Radians to Degrees1'
 * '<S6>'   : 'q_qube2_swingup/State X'
 * '<S7>'   : 'q_qube2_swingup/Swing-Up Control'
 * '<S8>'   : 'q_qube2_swingup/mu'
 * '<S9>'   : 'q_qube2_swingup/Swing-Up Control/Energy-Based Swing-Up Control'
 * '<S10>'  : 'q_qube2_swingup/Swing-Up Control/Energy-Based Swing-Up Control/Pendulum Energy'
 * '<S11>'  : 'q_qube2_swingup/Swing-Up Control/Energy-Based Swing-Up Control/User Specified Acceleration Limit'
 */
#endif                                 /* q_qube2_swingup_h_ */
