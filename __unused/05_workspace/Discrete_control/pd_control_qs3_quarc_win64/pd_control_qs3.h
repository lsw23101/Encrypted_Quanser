...
#ifndef pd_control_qs3_h_
#define pd_control_qs3_h_
#ifndef pd_control_qs3_COMMON_INCLUDES_
#define pd_control_qs3_COMMON_INCLUDES_
#include <math.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* pd_control_qs3_COMMON_INCLUDES_ */

#include "pd_control_qs3_types.h"
...
#define pd_control_qs3_rtModel         RT_MODEL_pd_control_qs3_T

/* Block signals (default storage) */
typedef struct {
  real_T HILReadTimebase_o1;           /* '<S3>/HIL Read Timebase' */
  real_T HILReadTimebase_o2;           /* '<S3>/HIL Read Timebase' */
  real_T HILReadTimebase_o3;           /* '<S3>/HIL Read Timebase' */
  real_T HILReadTimebase_o5;           /* '<S3>/HIL Read Timebase' */
  real_T HILReadTimebase_o6;           /* '<S3>/HIL Read Timebase' */
  real_T SmoothSignalGenerator;        /* '<Root>/Smooth Signal Generator' */
  real_T Amplituderad;                 /* '<Root>/Amplitude (rad)' */
  real_T countstorads;                 /* '<Root>/counts to rads' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T SliderGain;                   /* '<S2>/Slider Gain' */
  real_T countsstorads;                /* '<Root>/counts//s to rad//s' */
  real_T SliderGain_b;                 /* '<S1>/Slider Gain' */
  real_T Sum1;                         /* '<Root>/Sum1' */
  real_T u0VLimit;                     /* '<Root>/+//- 10V Limit' */
  boolean_T HILReadTimebase_o4;        /* '<S3>/HIL Read Timebase' */
} B_pd_control_qs3_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_FilterFrequency[2];/* '<S3>/HIL Initialize' */
  real_T HILReadTimebase_AnalogBuffer; /* '<S3>/HIL Read Timebase' */
  real_T HILReadTimebase_OtherBuffer[2];/* '<S3>/HIL Read Timebase' */
  ...
  t_boolean HILReadTimebase_DigitalBuffer;/* '<S3>/HIL Read Timebase' */
} DW_pd_control_qs3_T;

/* Backward compatible GRT Identifiers */
#define rtB                            pd_control_qs3_B
#define BlockIO                        B_pd_control_qs3_T
#define rtP                            pd_control_qs3_P
#define Parameters                     P_pd_control_qs3_T
#define rtDWork                        pd_control_qs3_DW
#define D_Work                         DW_pd_control_qs3_T

/* Parameters (default storage) */
struct P_pd_control_qs3_T_ {
  real_T ProportionalGain_gain;        /* Mask Parameter: ProportionalGain_gain
                                        * Referenced by: '<S2>/Slider Gain'
                                        */
  real_T DerivativeGain_gain;          /* Mask Parameter: DerivativeGain_gain
  ...
  real_T SmoothSignalGenerator_Frequency;/* Expression: i_frequency
                                          * Referenced by: '<Root>/Smooth Signal Generator'
                                          */
  real_T Amplituderad_Gain;            /* Expression: 1.5
                                        * Referenced by: '<Root>/Amplitude (rad)'
                                        */
  real_T countstorads_Gain;            /* Expression: 2*pi/512/4
                                        * Referenced by: '<Root>/counts to rads'
                                        */
  real_T countsstorads_Gain;           /* Expression: 2*pi/512/4
...
struct tag_RTM_pd_control_qs3_T {
  const char_T *path;
...
extern P_pd_control_qs3_T pd_control_qs3_P;

/* Block signals (default storage) */
extern B_pd_control_qs3_T pd_control_qs3_B;

/* Block states (default storage) */
extern DW_pd_control_qs3_T pd_control_qs3_DW;

/* External data declarations for dependent source files */
extern const real_T pd_control_qs3_RGND;/* real_T ground */

/* Model entry point functions */
extern void pd_control_qs3_initialize(void);
extern void pd_control_qs3_output(void);
extern void pd_control_qs3_update(void);
extern void pd_control_qs3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern pd_control_qs3_rtModel *pd_control_qs3(void);
...
extern RT_MODEL_pd_control_qs3_T *const pd_control_qs3_M;
 ...
 *
 * '<Root>' : 'pd_control_qs3'
 * '<S1>'   : 'pd_control_qs3/Derivative Gain'
 * '<S2>'   : 'pd_control_qs3/Proportional  Gain'
 * '<S3>'   : 'pd_control_qs3/Qube-Servo 3 - IO (QAL)'
 */
#endif                                 /* pd_control_qs3_h_ */
