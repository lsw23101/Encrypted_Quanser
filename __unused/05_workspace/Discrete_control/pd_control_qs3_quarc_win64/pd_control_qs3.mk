###########################################################################
## Makefile generated for component 'pd_control_qs3'. 
## 
## Makefile     : pd_control_qs3.mk
## Generated on : Wed Sep 17 15:39:01 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\pd_control_qs3.rt-win64
...
COMPILER_COMMAND_FILE     = pd_control_qs3_comp.rsp
CMD_FILE                  = pd_control_qs3.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\pd_control_qs3.rt-win64
...
DEFINES_STANDARD = -DMODEL=pd_control_qs3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3.c $(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3_data.c $(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3_main.c $(START_DIR)\pd_control_qs3_quarc_win64\rtGetInf.c $(START_DIR)\pd_control_qs3_quarc_win64\rtGetNaN.c $(START_DIR)\pd_control_qs3_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = pd_control_qs3.obj pd_control_qs3_data.obj pd_control_qs3_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\pd_control_qs3_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\pd_control_qs3_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
pd_control_qs3.obj : "$(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3.c"


pd_control_qs3_data.obj : "$(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3_data.c"


pd_control_qs3_main.obj : "$(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pd_control_qs3_quarc_win64\pd_control_qs3_main.c"


rtGetInf.obj : "$(START_DIR)\pd_control_qs3_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pd_control_qs3_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\pd_control_qs3_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pd_control_qs3_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\pd_control_qs3_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pd_control_qs3_quarc_win64\rt_nonfinite.c"
