...
F = np.array([
    [ 0.8504, -2.0248, 0.1518, -0.1523 ],
    [ 0.3871, -1.7367, 0.1030, -0.1017 ],
    [ 15.0436, -78.3074, 5.1986, -6.2170 ],
    [ 16.9703, -84.6462, 4.3414, -5.2869 ]
], dtype=np.float64)
...
H = np.array([ 6.2932, -28.4520, 1.5884, -2.4262 ], dtype=np.float64)  # shape (4,)
