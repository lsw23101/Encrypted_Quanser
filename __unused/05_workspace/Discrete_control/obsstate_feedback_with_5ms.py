...
F = np.array([
    [ 0.4672, -0.0626, 0.0087, -0.0046 ],
    [ 0.0052, 0.3946, 0.0036, 0.0004 ],
    [ -8.6156, -21.3572, 2.4679, -1.8534 ],
    [ 5.7679, -35.9436, 1.4515, -0.8313 ]
], dtype=np.float64)
...
H = np.array([ 25.8510, -83.0321, 5.9004, -7.4575 ], dtype=np.float64)  # shape (4,)
