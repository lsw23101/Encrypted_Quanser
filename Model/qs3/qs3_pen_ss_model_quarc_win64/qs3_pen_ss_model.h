...
#ifndef qs3_pen_ss_model_h_
#define qs3_pen_ss_model_h_
#ifndef qs3_pen_ss_model_COMMON_INCLUDES_
#define qs3_pen_ss_model_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* qs3_pen_ss_model_COMMON_INCLUDES_ */

#include "qs3_pen_ss_model_types.h"
#include <string.h>
...
#define qs3_pen_ss_model_rtModel       RT_MODEL_qs3_pen_ss_model_T

/* Block signals (default storage) */
typedef struct {
  real_T AmplitudeV;                   /* '<Root>/Amplitude (V)' */
  real_T ForveCCWmotion;               /* '<Root>/For +ve CCW  motion' */
  real_T plant;                        /* '<Root>/Base: counts to rad' */
  real_T StateSpaceModel[4];           /* '<Root>/State-Space Model' */
  real_T plant_e;                      /* '<Root>/Pendulum: counts to rad' */
} B_qs3_pen_ss_model_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_FilterFrequency[2];/* '<S1>/HIL Initialize' */
  real_T HILReadTimebase_AnalogBuffer; /* '<S1>/HIL Read Timebase' */
  real_T HILReadTimebase_OtherBuffer[2];/* '<S1>/HIL Read Timebase' */
  ...
  struct {
    void *LoggedData;
  } BaseEncoderAnglerad_PWORK;         /* '<Root>/Base Encoder Angle (rad)' */
  ...
  int32_T HILInitialize_DOStates;      /* '<S1>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[2];/* '<S1>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[2];/* '<S1>/HIL Initialize' */
  int32_T HILReadTimebase_EncoderBuffer[2];/* '<S1>/HIL Read Timebase' */
  t_boolean HILReadTimebase_DigitalBuffer;/* '<S1>/HIL Read Timebase' */
} DW_qs3_pen_ss_model_T;

/* Continuous states (default storage) */
typedef struct {
  real_T StateSpaceModel_CSTATE[4];    /* '<Root>/State-Space Model' */
} X_qs3_pen_ss_model_T;

/* State derivatives (default storage) */
typedef struct {
  real_T StateSpaceModel_CSTATE[4];    /* '<Root>/State-Space Model' */
} XDot_qs3_pen_ss_model_T;

/* State disabled  */
typedef struct {
  boolean_T StateSpaceModel_CSTATE[4]; /* '<Root>/State-Space Model' */
} XDis_qs3_pen_ss_model_T;
...
#define rtB                            qs3_pen_ss_model_B
#define BlockIO                        B_qs3_pen_ss_model_T
#define rtX                            qs3_pen_ss_model_X
#define ContinuousStates               X_qs3_pen_ss_model_T
#define rtXdot                         qs3_pen_ss_model_XDot
#define StateDerivatives               XDot_qs3_pen_ss_model_T
#define tXdis                          qs3_pen_ss_model_XDis
#define StateDisabled                  XDis_qs3_pen_ss_model_T
#define rtP                            qs3_pen_ss_model_P
#define Parameters                     P_qs3_pen_ss_model_T
#define rtDWork                        qs3_pen_ss_model_DW
#define D_Work                         DW_qs3_pen_ss_model_T

/* Parameters (default storage) */
struct P_qs3_pen_ss_model_T_ {
  ...
  real_T AmplitudeV_Gain;              /* Expression: 1
                                        ...
                                        */
  real_T ForveCCWmotion_Gain;          /* Expression: -1
                                        * Referenced by: '<Root>/For +ve CCW  motion'
                                        */
  real_T Basecountstorad_Gain;         /* Expression: 1
                                        * Referenced by: '<Root>/Base: counts to rad'
                                        */
  real_T StateSpaceModel_InitialConditio[4];/* Expression: [0 0 0 0]
                                             * Referenced by: '<Root>/State-Space Model'
                                             */
  real_T Pendulumcountstorad_Gain;     /* Expression: 1
  ...
  uint32_T HILReadTimebase_SamplesInBuffer;
                           ...
                           * Referenced by: '<S1>/HIL Read Timebase'
                           */
  uint32_T HILReadTimebase_AnalogChannels;
  ...
  uint32_T HILReadTimebase_EncoderChannels[2];
                           ...
                           * Referenced by: '<S1>/HIL Read Timebase'
                           */
  uint32_T HILReadTimebase_DigitalChannels;
                          /* Computed Parameter: HILReadTimebase_DigitalChannels
                           * Referenced by: '<S1>/HIL Read Timebase'
                           */
  uint32_T HILReadTimebase_OtherChannels[2];
...
struct tag_RTM_qs3_pen_ss_model_T {
  const char_T *path;
...
extern P_qs3_pen_ss_model_T qs3_pen_ss_model_P;

/* Block signals (default storage) */
extern B_qs3_pen_ss_model_T qs3_pen_ss_model_B;

/* Continuous states (default storage) */
extern X_qs3_pen_ss_model_T qs3_pen_ss_model_X;

/* Disabled states (default storage) */
extern XDis_qs3_pen_ss_model_T qs3_pen_ss_model_XDis;

/* Block states (default storage) */
extern DW_qs3_pen_ss_model_T qs3_pen_ss_model_DW;

/* External data declarations for dependent source files */
extern const real_T qs3_pen_ss_model_RGND;/* real_T ground */

/* Model entry point functions */
extern void qs3_pen_ss_model_initialize(void);
extern void qs3_pen_ss_model_output(void);
extern void qs3_pen_ss_model_update(void);
extern void qs3_pen_ss_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern qs3_pen_ss_model_rtModel *qs3_pen_ss_model(void);
...
extern RT_MODEL_qs3_pen_ss_model_T *const qs3_pen_ss_model_M;
 ...
 *
 * '<Root>' : 'qs3_pen_ss_model'
 * '<S1>'   : 'qs3_pen_ss_model/Qube-Servo 3 - IO (QAL)'
 */
#endif                                 /* qs3_pen_ss_model_h_ */
