###########################################################################
## Makefile generated for component 'qs3_pen_ss_model'. 
## 
## Makefile     : qs3_pen_ss_model.mk
## Generated on : Thu Feb 05 18:21:48 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\qs3_pen_ss_model.rt-win64
...
COMPILER_COMMAND_FILE     = qs3_pen_ss_model_comp.rsp
CMD_FILE                  = qs3_pen_ss_model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\qs3_pen_ss_model.rt-win64
...
DEFINES_STANDARD = -DMODEL=qs3_pen_ss_model -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model.c $(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model_data.c $(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model_main.c $(START_DIR)\qs3_pen_ss_model_quarc_win64\rtGetInf.c $(START_DIR)\qs3_pen_ss_model_quarc_win64\rtGetNaN.c $(START_DIR)\qs3_pen_ss_model_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = qs3_pen_ss_model.obj qs3_pen_ss_model_data.obj qs3_pen_ss_model_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\qs3_pen_ss_model_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\qs3_pen_ss_model_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
qs3_pen_ss_model.obj : "$(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model.c"


qs3_pen_ss_model_data.obj : "$(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model_data.c"


qs3_pen_ss_model_main.obj : "$(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qs3_pen_ss_model_quarc_win64\qs3_pen_ss_model_main.c"


rtGetInf.obj : "$(START_DIR)\qs3_pen_ss_model_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qs3_pen_ss_model_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\qs3_pen_ss_model_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qs3_pen_ss_model_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\qs3_pen_ss_model_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qs3_pen_ss_model_quarc_win64\rt_nonfinite.c"
